...
class ItemDetailActivity : AppCompatActivity() {
    ...
    private fun editItem() {
       CoroutineScope(Dispatchers.IO).launch {
            val result = safeApiCall { RetrofitClient.apiService.updateItem(item.id, item.value.copy(
                profession = binding.professional.text.toString()
            )) }
    ...
    private fun handleSuccess() {
        ...
        binding.professional.setText(item.value.profession)
